...
//						fieldValues.push(this.getBytes(4, valueOffset + indexOffset) + this.getBytes(4, valueOffset + indexOffset + 4));
	...
	clampColorSample: function(colorSample, bitsPerSample) {
		...
		return colorSample / Math.pow(2, bitsPerSample);
	},
...
//		console.log( strips );
		...
		var floatArray = new Float32Array(imageWidth * imageLength * (photometricInterpretation < 2 ? 1 : 3));
		var pixelIndex = 0;
				...
				for (var x = 0; x < imageWidth; x++, j++) {
					...
					switch (photometricInterpretation) {
						...
						case 2:
							...
							floatArray[pixelIndex * 3] = red;
							floatArray[pixelIndex * 3 + 1] = green;
							floatArray[pixelIndex * 3 + 2] = blue;
						break;
